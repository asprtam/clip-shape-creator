...
const localisationEN = {
    hints: {
        ...
        andTheLineIsNotCurved: 'and the line is not curved you will also drag curve control points to keep the line flat.',
    ...
    pl: {
        ...
        texts: {
            hints: {
                ...
                andTheLineIsNotCurved: 'a linia nie jest zakrzywiona. Przeciągniesz również punkty kontrolne krzywej, aby linia pozostała płaska.',
                ...
                dragOnlyDesired: 'aby przeciągnąć tylko żądany punkt ścieżki i umożliwić zakrzywienie linii prostej.',
                close: 'Zamknij',
                show: 'Pokaż pomoc',
